...
function Header() {
    return (
        <>
            {/* Header para escritorio y tablet */}
            <aside className="hidden lg:flex h-full py-20 pl-6 md:pl-10 lg:pl-24 2xl:pl-80 pr-6 flex-col justify-between bg-[#0a192f]">
                {/* Nombre */}
                <div>
                ...
                {/* Navegación */}
                <nav className="flex flex-col gap-5 mt-20 xl:mt-12 xl:mb-10 text-base font-medium text-gray-400">
                ...
                {/* Imagen visible en escritorio y tablet */}
                <img
                    src="/profile-image.jpg"
                    alt="Foto de David"
                    className="w-56 h-56 md:w-60 md:h-60 lg:w-64 lg:h-64 xl:w-50 xl:h-50 xl:mt-1 2xl:mt-10 xl:mb-6 2xl:w-64 2xl:h-64 object-cover rounded-full border-4 border-[#64ffda] shadow-lg"
                />
            ...
            {/* Header para móvil con imagen visible y grande */}
